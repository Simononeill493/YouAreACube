...
namespace IAmACube
{
    class PreDemoScreen : MenuScreen
    {
        ...
        public PreDemoScreen(Action<ScreenType> switchScreen) : base(ScreenType.PreDemo, switchScreen)
        {
            ...
            var dialogue = new TextDialogueBox(this, new IntPoint(85, 30), 63, 0.5f);
            ...
            dialogue.SetText("1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890");
        }
    }
